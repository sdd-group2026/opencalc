...
class ExpressionUnitTest {
    ...
    private fun CalculationResult.toDouble(): Double = value.toDouble()
    ...
    fun trigonometric_functions_isCorrect() {
        ...
        assertEquals(
            CalculationResult.Error.DomainError(),
            calculate("tan(π/2)", false)
        )

        assertEquals(
            CalculationResult.Error.DomainError(),
            calculate("tan(3π/2)", false)
        )

        assertEquals(
            CalculationResult.Error.DomainError(),
            calculate("tan(90)", true)
        )

        assertEquals(
            CalculationResult.Error.DomainError(),
            calculate("tan(270)", true)
        )

        result = calculate("sin(2π)", false).toDouble()
        assertEquals(0.0, result, 0.0)

        result = calculate("sin(360)", true).toDouble()
        assertEquals(0.0, result, 0.0)
