...
class NumberFormatterTest {
    ...
    @Test
    fun `given Indian numbering system with non-comma grouping separator then formatting uses custom separator`() {
        // Given
        val number = "1234567.89"

        // When
        val result = formatter.format(number, decimalSeparator, " ", NumberingSystem.INDIAN)
